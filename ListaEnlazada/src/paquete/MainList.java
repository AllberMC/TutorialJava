...
public class MainList {
	...
	public static void main(String[] args) {
		...
		lista.add("Palabra"); //Añadimos el dato donde estemos situado
		...
		System.out.println("El tamaño de la lista es: " + lista.size()); //con size obtenemos el tamaño total que vamos obteniendo de la lista
		System.out.println(lista.get(2)); //El metodo get nos permite obtener el dato pasandole la pos de la que queremos obtenerlo
		System.out.println(lista.getFirst()); //Con getFirst obtenemos siempre el primer dato que se añadio en la lista(pos 0)
